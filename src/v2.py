                ...
                for k, v in serv_poll.items():
                    if vm[req[1]][2] == 1:                      # 双节点部署
                        if v[1] >= vm[req[1]][0]/2 and \
                            ...
                            if i < Days*3//4 and ((v[1] - vm[req[1]][0] < 5 and v[2] - vm[req[1]][1] > 60) or
                                    (v[1] - vm[req[1]][0] > 60 and v[2] - vm[req[1]][1] < 5)):
                                continue
                        ...
                        if v[1] >= vm[req[1]][0] and v[2] >= vm[req[1]][1]:
                            if i < Days//6:           # 前一半
                                ...
                                if value_rd(vm[req[1]][3], round(v[1]/v[2], 1), r):
                                    if (v[1] - vm[req[1]][0] < 5 and v[2] - vm[req[1]][1] > 60) or \
                                            (v[1] - vm[req[1]][0] > 60 and v[2] - vm[req[1]][1] < 5):
                                        continue
                            ...
                            if i < Days//6:
                                ...
                                if value_rd(vm[req[1]][3], round(v[3]/v[4], 1), r):
                                    if (v[3] - vm[req[1]][0] < 5 and v[4] - vm[req[1]][1] > 60) or \
                                            (v[3] - vm[req[1]][0] > 60 and v[4] - vm[req[1]][1] < 5):
                                        continue
